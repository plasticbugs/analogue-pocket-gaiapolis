...
**Status: release v0.2.1 -- the game runs on the Pocket, rotating and zooming
backgrounds included, the three renderers sharing the memory cleanly.** The whole machine
